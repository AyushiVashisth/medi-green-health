                        ...
                        {allData.map((elem) => (
                            ...
                            >
                                ...
                                <VStack textAlign={"left"} >
                                    ...
                                    <Text mr={["19px","29px","39px","49px","59px"]} fontSize={"14px"}>MRP ₹  <span style={{ "text-decoration": "line-through", color: "red" }}>
                                        {elem.price + 400}
                                    </span> <span style={{  color: "green" }}> {elem.discount}%</span></Text>
