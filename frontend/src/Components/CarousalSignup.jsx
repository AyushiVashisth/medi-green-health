      ...
      <Slider {...settings}>
        <Box justifyContent="center" w="100%" h="250px" textAlign="center">
          ...
          <Text w="100%" textAlign="center" fontSize="xs">
            view medicine information like usage sideeffects and cheaper
            substutes before you take them
          </Text>
          <br />
        </Box>
        <Box justifyContent="center" w="600px" h="250px" textAlign="center">
          ...
          <br />
          <Text w="100%" textAlign="center" fontSize="xs">
            Order any medicine or health product and we will deliver it for
            free.Enjoy discount on everything{" "}
          </Text>
          <br />
        </Box>
        <Box justifyContent="center" w="600px" h="250px" textAlign="center">
          ...
          <br />
          <Text w="100%" textAlign="center" fontSize="xs">
            Book any test from any lab.we will collect the sample and send the
            reports save upto 80% on everytime
          </Text>
          <br />
        </Box>
        <Box justifyContent="center" w="600px" h="250px" textAlign="center">
          ...
          <br />
          <Text w="100%" textAlign="center" fontSize="xs">
            Get medicine information,order medicines.booklab tests and consult
            doctors online from the comfort of your home
          </Text>
          <br />
        </Box>
        <Box justifyContent="center" w="600px" h="250px" textAlign="center">
          ...
          <br />
          <Text w="100%" textAlign="center" fontSize="xs">
            Consult Our certified doctors from anywhere anytime,and for free,we
            guarentee your privacy
          </Text>
          <br />
        </Box>
      </Slider>
